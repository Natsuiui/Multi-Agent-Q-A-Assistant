...
def get_vectorstore():
    if os.path.exists("Multi-Agent-Q-A-Assistant/QA-Assistant/faiss_index"):
        return FAISS.load_local("Multi-Agent-Q-A-Assistant/QA-Assistant/faiss_index", SentenceTransformerEmbeddings(model_name="all-MiniLM-L6-v2"), allow_dangerous_deserialization=True)
    else:
        file_paths = [
        ...
        vs.save_local("Multi-Agent-Q-A-Assistant/QA-Assistant/faiss_index")
        return vs
